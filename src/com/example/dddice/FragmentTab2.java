...
public class FragmentTab2 extends Fragment 
{
	...
	//static AnimationDrawable d6Animation;
	                           ...
	                           Bundle savedInstanceState)
	  {
		...
		image.setBackgroundResource(R.drawable.d6_animated);
	  ...
	  public static void finalRoll(int min, int max) 
	  {
		...
		int outcome = randInt(min,max);
      	...
      	if(outcome==1)
      	{
      		image.setBackgroundResource(R.drawable.d6_1);
      	} else if(outcome==2) {
      		image.setBackgroundResource(R.drawable.d6_2);
      	}else if(outcome==3) {
      		image.setBackgroundResource(R.drawable.d6_3);
      	}else if(outcome==4) {
      		image.setBackgroundResource(R.drawable.d6_4);
      	}else if(outcome==5) {
      		image.setBackgroundResource(R.drawable.d6_5);
      	}else if(outcome==6) {
      		image.setBackgroundResource(R.drawable.d6_6);
      	}
