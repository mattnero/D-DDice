...
public class FragmentTab4 extends Fragment 
{
	...
	static ImageView image;
	                           ...
	                           Bundle savedInstanceState)
	  {
		...
		roll_button = (ImageButton) view.findViewById(R.id.roll_button);
		
		final MediaPlayer mp = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.rollsound);
		
		image.setBackgroundResource(R.drawable.d10_animated);
	  ...
	  public static void finalRoll(int min, int max) 
	  {
		...
		int outcome = randInt(min,max);
      	...
      	if(outcome==1)
      	{
      		image.setBackgroundResource(R.drawable.d10_1);
      	} else if(outcome==2) {
      		image.setBackgroundResource(R.drawable.d10_2);
      	}else if(outcome==3) {
      		image.setBackgroundResource(R.drawable.d10_3);
      	}else if(outcome==4) {
      		image.setBackgroundResource(R.drawable.d10_4);
      	}else if(outcome==5) {
      		image.setBackgroundResource(R.drawable.d10_5);
      	}else if(outcome==6) {
      		image.setBackgroundResource(R.drawable.d10_6);
      	}else if(outcome==7) {
      		image.setBackgroundResource(R.drawable.d10_7);
      	}else if(outcome==8) {
      		image.setBackgroundResource(R.drawable.d10_8);
      	}else if(outcome==9) {
      		image.setBackgroundResource(R.drawable.d10_9);
      	}else if(outcome==0) {
      		image.setBackgroundResource(R.drawable.d10_0);
      	}
